...
$this->title = Yii::t('app', 'yearlings');
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        document.body.classList.add('bg-yearlings');
                    ...
                    <div class="row justify-content-center">
                        <div class="col-10 col-lg-5 py-3">
                            <div class="card yearlings-card">
                                ...
                                <?php if ($horses[$i]->url) { ?>
                                    <p class="card-text text-center">
                                        <a href="<?= Html::encode($horses[$i]->url) ?>" class="btn outline-button2">
                                            <?= Yii::t('app', 'sale-yearlings'); ?>
                                        </a>
                                    </p>
                                <?php } ?>
